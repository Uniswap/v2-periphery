...
import 'dxswap-core/contracts/interfaces/IDXswapCallee.sol';
...
contract ExampleFlashSwap is IDXswapCallee {
    ...
    function DXswapCall(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        assert(msg.sender == DXswapLibrary.pairFor(factory, token0, token1)); // ensure that msg.sender is actually a V2 pair
        ...
        if (amountToken > 0) {
            ...
            uint amountRequired = DXswapLibrary.getAmountsIn(factory, amountToken, path)[0];
            ...
            uint amountRequired = DXswapLibrary.getAmountsIn(factory, amountETH, path)[0];
